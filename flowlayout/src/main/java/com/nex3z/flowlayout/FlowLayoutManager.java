...
public class FlowLayoutManager {
    ...
    // Helper methods
    private TextView buildLabel(String text, final onFlowViewClick onFlowViewClick) {
    ...
    private FlowLayoutManager buildFlowView() {
        ...
        for (String text : keys) {
            TextView textView = buildLabel(text, onFlowViewClick);
    ...
    public static class FlowViewBuilder {
        ...
        public FlowLayoutManager build() {
            FlowLayoutManager flowLayoutManager = new FlowLayoutManager(mContext, mFlowLayout, mKeys, mOnFlowViewClick, mIsSingleChoice)
                    .buildFlowView();
