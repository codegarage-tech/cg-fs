 ...
 */
public class RestaurantFilterFragment extends AAH_FabulousFragment {
    ...
    private static String TAG = RestaurantFilterFragment.class.getSimpleName();

    public static RestaurantFilterFragment newInstance(ArrayMap<String, List<String>> data) {
        ...
        RestaurantFilterFragment mff = new RestaurantFilterFragment();
