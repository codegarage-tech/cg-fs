 ...
 */
public class AndroidPayCardListViewAdapter extends BaseAdapter {

    private Activity mActivity;
    private ArrayList<StripeCard> mData;
    private static LayoutInflater inflater = null;
    private int lastSelectedPosition = -1;
    private String TAG = AndroidPayCardListViewAdapter.class.getSimpleName();

    public AndroidPayCardListViewAdapter(Activity activity) {
        mActivity = activity;
...
//        }
    ...
    public View getView(final int position, final View convertView, final ViewGroup parent) {
        ...
        View vi = convertView;
        if (convertView == null)
            vi = inflater.inflate(R.layout.list_row_android_pay_card, null);
