 ...
 */
public class RibbleActivity extends BaseActivity {
...
//    UserBasicInfo userBasicInfo;
    ...
    private String TAG = RibbleActivity.class.getSimpleName();
...
//
//        if (!AppUtils.isNullOrEmpty(SessionManager.getStringSetting(RibbleActivity.this, SESSION_USER_BASIC_INFO))) {
//            Log.d(TAG, "Session data: " + SessionManager.getStringSetting(RibbleActivity.this, SESSION_USER_BASIC_INFO));
//            userBasicInfo = UserBasicInfo.getResponseObject(SessionManager.getStringSetting(RibbleActivity.this, SESSION_USER_BASIC_INFO), UserBasicInfo.class);
//        }
        ...
        drawerLayout.addDrawerListener(new DrawerLayout.SimpleDrawerListener() {
            ...
            public void onDrawerSlide(View drawerView, float slideOffset) {
                ...
                contentHome.setCardElevation(slideOffset * AppUtils.toPx(RibbleActivity.this, 10));

                //Restaurant owner status
                if (!SessionManager.getBooleanSetting(RibbleActivity.this, SESSION_IS_RESTAURANT_LOGGED_IN, false)) {
    ...
    public void handleMenuItemsChanges(NavigationItem item) {
        ...
        SessionManager.setStringSetting(RibbleActivity.this, SESSION_SELECTED_NAVIGATION_MENU, item.getId().getName());
        ...
        if (item.getName().equalsIgnoreCase(NavigationId.HOME.INSTANCE.getName())) {
            ...
            Intent intentAddress = new Intent(RibbleActivity.this, LocationListActivity.class);
            startActivity(intentAddress);
        } else if (item.getName().equalsIgnoreCase(NavigationId.NOTIFICATION.INSTANCE.getName())) {
            checkPosition = 2;
            Toast.makeText(RibbleActivity.this, getString(R.string.toast_under_development), Toast.LENGTH_SHORT).show();
            ...
            if (!SessionManager.getBooleanSetting(RibbleActivity.this, SESSION_IS_RESTAURANT_LOGGED_IN, false)) {
                Intent intent = new Intent(RibbleActivity.this, RestaurantLoginActivity.class);
                startActivityForResult(intent, INTENT_REQUEST_CODE_ADD_RESTAURANT_LOGIN);
            } else {
                Intent intentRestaurant = new Intent(RibbleActivity.this, AboutRestaurantActivity.class);
            ...
            SessionManager.removeSetting(RibbleActivity.this, SESSION_IS_RESTAURANT_LOGGED_IN);
            SessionManager.removeSetting(RibbleActivity.this, SESSION_RESTAURANT_LOGIN_DATA);
    ...
    private void goFragmentScreen(String currentTag, Fragment fragment) {
        FragmentUtilsManager.changeSupportFragment(RibbleActivity.this, fragment, currentTag);
    }
