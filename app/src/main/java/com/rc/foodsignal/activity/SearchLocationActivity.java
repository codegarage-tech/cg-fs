 ...
 */
public class SearchLocationActivity extends BaseLocationActivity {

    String TAG = AppUtils.getTagName(SearchLocationActivity.class);
    TextView tvTitle;
    ImageView ivBack;
...
//    DoAddAddress doAddAddress;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!NetworkManager.isConnected(SearchLocationActivity.this)) {
            Toast.makeText(SearchLocationActivity.this, getResources().getString(R.string.toast_network_error), Toast.LENGTH_SHORT).show();
            return;
        }
    }
    ...
    private void initAddLocationUI() {
        if (!AppUtils.isNullOrEmpty(SessionManager.getStringSetting(SearchLocationActivity.this, SESSION_USER_BASIC_INFO))) {
            Log.d(TAG, "Session data: " + SessionManager.getStringSetting(SearchLocationActivity.this, SESSION_USER_BASIC_INFO));
            userBasicInfo = UserBasicInfo.getResponseObject(SessionManager.getStringSetting(SearchLocationActivity.this, SESSION_USER_BASIC_INFO), UserBasicInfo.class);
        }

        ivBack = (ImageView) findViewById(R.id.iv_back);
        tvTitle = (TextView) findViewById(R.id.text_title);
        tvTitle.setText(getString(R.string.title_activity_search_location));
        ...
        llDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (acPlace.getText().toString().equalsIgnoreCase("")) {
                    Toast.makeText(SearchLocationActivity.this, getResources().getString(R.string.toast_empty_address_field), Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                com.rc.foodsignal.model.Location location = new com.rc.foodsignal.model.Location("","",street,city,state,zip,country,latitude,longitude);
                Intent intent = new Intent();
                intent.putExtra(INTENT_KEY_SEARCH_ADDRESS, location);
                setResult(RESULT_OK, intent);
                finish();
//                doAddAddress = new DoAddAddress(SearchLocationActivity.this, userBasicInfo.getUser_id(), street, city, state, zip, country, latitude, longitude);
...
//                                        mZip.setText(component.long_name);
    ...
    private void setCurrentLocationDetail(Location location) {
        ...
        currentLocationTask = new ReverseGeocoderTask(SearchLocationActivity.this, new LocationAddressListener() {
            @Override
...
//                    SessionManager.setStringSetting(SearchLocationActivity.this, SESSION_SELECTED_LOCATION, responseData.getData().get(0).toString());
//                    SessionManager.setBooleanSetting(SearchLocationActivity.this, SESSION_IS_LOCATION_ADDED, true);
//
//                    Intent intent = new Intent();
...
//                    finish();
//                } else {
//                    Toast.makeText(SearchLocationActivity.this, getResources().getString(R.string.toast_no_info_found), Toast.LENGTH_SHORT).show();
//                }
//
//            } else {
//                Toast.makeText(SearchLocationActivity.this, getResources().getString(R.string.toast_could_not_retrieve_info), Toast.LENGTH_SHORT).show();
//            }
//        }
//    }
}